...
namespace CineApi.Controllers
{
    ...
    public class PeliculaController : ControllerBase
    {
        ...
        {
            peliculas.Add(new Pelicula(1, "RED ONE","EnlaceImagen","Jake Kasdan", 148, "Nick Kroll, Dwayne Johnson, Chris Evans, Kristofer Hivju, Kiernan Shipka, Bonnie Hunt, Mary Elizabeth Ellis, Wesley Kimmel, Lucy Liu, J.K. Simmons",
            ...
            1, 5));      
            peliculas.Add(new Pelicula(2, "VENOM 3", "EnlaceImagen","Kelly Marcel", 138, "Rhys Ifans, Chiwetel Ejiofor, Tom Hardy, Stephen Graham, Alanna Ubach, Juno Temple, Clark Backo, Peggy Lu",
            ...
            2, 1));
            peliculas.Add(new Pelicula(3, "GLADIATOR II", "EnlaceImagen","Ridley Scott", 138, "Paul Mescal, Denzel Washington, Connie Nielsen, Joseph Quinn, Derek Jacobi, Fred Hechinger, Lior Raz, Pedro Pascal",
            ...
            3, 4));
            peliculas.Add(new Pelicula(3, "TERRIFIER 3", "EnlaceImagen","Chris Sanders", 100, "Bill Nighy, Lupita Nyong'o, Stephanie Hsu, Mark Hamill, Ving Rhames, Matt Berry, Pedro Pascal, Kit Connor",
