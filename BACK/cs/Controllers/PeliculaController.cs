...
namespace CineApi.Controllers
{
    ...
    public class PeliculaController : ControllerBase
    {
        ...
        {
            peliculas.Add(new Pelicula(1, "RED ONE","../imgs/venom3.jpg","Jake Kasdan", 148, "Nick Kroll, Dwayne Johnson, Chris Evans, Kristofer Hivju, Kiernan Shipka, Bonnie Hunt, Mary Elizabeth Ellis, Wesley Kimmel, Lucy Liu, J.K. Simmons",
